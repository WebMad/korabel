...
@section('content')
    <div class="login">
        <h2>Регистрация</h2>
        <p align="justify"><span class="error_message">Внимание!</span> Регистрация разрешена лишь для собственников участков на территории данного садоводческого товарищества, в противном случае ваш аккаунт будет удален.</p>
